<template>
    <div class="animated fadeIn">
        ...
        <b-row>
            <b-col sm="12">
                <b-card>
                    <b-button size="lg" class="ui primary button" @click="createSchool">Create New Student</b-button>
                    <br>
                    <hr>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered">
                            ...
                            <tr v-for="(item,key) in items.data">
                                ...
                                <td>{{item.attributes['first-name']}}</td>
                                <td>{{item.attributes['last-name']}}</td>
                                <td>{{item.attributes['admission-no']}}</td>
    ...
    data () {
      return {
        ...
        defs: {
          ...
          api_source: 'http://test.fee-payment-api.netcengroup.com/api/students'
        },
        page_data: {
          page: 1,
          per_page: 10,
