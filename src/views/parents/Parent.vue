<template>
    <div class="animated fadeIn">
        ...
        <b-row>
            <b-col sm="12">
                <b-card>
                    <b-button size="lg" class="ui primary button" @click="createSchool">Create New Parent</b-button>
                    <br>
                    <hr>
  ...
  export default{
    ...
    data () {
      return {
        items: {},
        defs: {
          caption: 'Parents Data',
          api_source: 'http://test.fee-payment-api.netcengroup.com/api/parents'
        },
        page_data: {
          page: 1,
          per_page: 10,
